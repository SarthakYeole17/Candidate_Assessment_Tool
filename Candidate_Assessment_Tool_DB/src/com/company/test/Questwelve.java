...
/**
 * Servlet implementation class Questwelve
 */
public class Questwelve extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(highlyagree != null)
		{
			...
			try
			{
				...
				PreparedStatement ps1 = con.prepareStatement("update candidate set qtwelve =? where email=?");
				ps1.setString(1, ha);
				...
				if(i>0)
				{
					response.sendRedirect("ques13.html");
				}
