...
/**
 * Servlet implementation class Quesone
 */
public class Quesone extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(highlyagree != null)
		{
			...
			try
			{
				...
				PreparedStatement ps1 = con.prepareStatement("update candidate set qone =? where email=?");
				ps1.setString(1, ha);
