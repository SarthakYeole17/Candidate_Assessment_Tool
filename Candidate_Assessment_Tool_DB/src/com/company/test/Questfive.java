...
/**
 * Servlet implementation class Questfive
 */
public class Questfive extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(highlyagree != null)
		{
			...
			try
			{
				...
				PreparedStatement ps1 = con.prepareStatement("update candidate set qtfive =? where email=?");
				ps1.setString(1, ha);
				...
				if(i>0)
				{
					response.sendRedirect("submitform.html");
				}
