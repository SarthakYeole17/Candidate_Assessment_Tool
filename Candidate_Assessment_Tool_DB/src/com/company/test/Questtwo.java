...
/**
 * Servlet implementation class Questtwo
 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(highlyagree != null)
		{
			...
			try
			{
				...
				PreparedStatement ps1 = con.prepareStatement("update candidate set qttwo =? where email=?");
				ps1.setString(1, ha);
				...
				if(i>0)
				{
					response.sendRedirect("ques23.html");
				}
