    ...
    <div>
      <table class="table" ui-jq="footable" ui-options='{
        ...
        try
        {
        	...
        	PreparedStatement ps1 = con.prepareStatement("select * from job where hid =?");
        	ps1.setInt(1, TempUserData.getHid());
          ...
          <tr data-expanded="true">
            ...
            <td><a href="ShortList.jsp?jid=<%=rs.getInt(1) %>">View</a></td>
            <td><a href="deletejob.jsp?jid=<%=rs.getInt(1) %>">Delete..</a></td>
